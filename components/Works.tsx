      ...
      {/* <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <div className="max-w-2xl text-center mx-auto">
          <div className="mt-5 max-w-2xl">
            <h1 className="block font-black uppercase text-gray-800 text-3xl md:text-3xl lg:text-4xl dark:text-gray-200">
              What we do
            </h1>
          </div>

          <div className="mt-5 mb-20 max-w-3xl">
            <p className=" text-gray-600 dark:text-gray-400">
              SINAG Cagayan Valley aims to establish a Regional Startup
              Development platform to build and strengten the startup ecosystem
              in the region and to create a Regional Ecosystem Development
              Roadmap that will serve as guide in improving the startup
              ecosystem conditions in the region.
            </p>
          </div>
        </div>
      ...
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <div className="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
          ...
          <p className="mt-1 text-gray-600 dark:text-gray-400">
            SINAG Cagayan Valley aims to establish a Regional Startup
            Development platform to build and strengten the startup ecosystem in
            the region and to create a Regional Ecosystem Development Roadmap
            that will serve as guide in improving the startup ecosystem
            conditions in the region.
          </p>
        </div>
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <a
            className="group bg-white hover:bg-gray-300 rounded-xl p-5 transition-all dark:hover:bg-white/[.05]"
            href="#"
          >
            <div className="flex-shrink-0 relative rounded-xl overflow-hidden aspect-w-16 aspect-h-10">
              <Image
                className="object-cover rounded-xl group-hover:scale-105 transition-transform duration-500 ease-in-out w-full h-full"
                src="/Moa Signing.jpg"
                alt="Picture of the author"
                width={500}
                height={500}
