        ...
        <div className="max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
            <div className="col-span-full lg:col-span-2">
              <a
                className="flex-none uppercase text-xl font-semibold text-white"
                href="#"
                aria-label="Brand"
              >
              ...
              <div className="mt-3 grid space-y-3">
                <p className="text-sm">
                  <a
                    ...
                    href="#"
                  >
                    Email: sinag02secretariat@gmail.com
                  </a>
                </p>
                <p className="text-sm">
                  <a
                ...
                <p className="text-sm">
                  <a
                    ...
                    href="#"
                  >
                    Address: 2F Floor, Research Building, Cagayan State
          ...
          <div className="mt-5 sm:mt-12 grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-center sm:items-center">
            <div className="flex justify-between items-center ">
              <p className="text-sm  text-gray-400">
                © 2023 SINAG Cagayan Valley. All rights reserved.
              </p>
            </div>
